...
use TONYLABS\Shopify\REST\Resources\ArticleResource;
use TONYLABS\Shopify\REST\Resources\AssetResource;
use TONYLABS\Shopify\REST\Resources\BlogResource;
use TONYLABS\Shopify\REST\Resources\PageResource;
...
trait ManagesOnlineStore
{
    ...
    public function paginateRedirects(array $params = []): Paginator
    {
        return $this->paginator($this->getRedirects($params));
    }
    ...
    public function paginateBlogs(array $params = []): Paginator
    {
        return $this->paginator($this->getBlogs($params));
    }
    ...
    public function paginatePages(array $params = []): Paginator
    {
        return $this->paginator($this->getPages($params));
    }
    ...
    public function paginateArticles(array $params = []): Paginator
    {
        return $this->paginator($this->getArticles($params));
    }
