...
use TONYLABS\Shopify\REST\Resources\CollectResource;
use TONYLABS\Shopify\REST\Resources\CustomCollectionResource;
use TONYLABS\Shopify\REST\Resources\ProductResource;
use TONYLABS\Shopify\REST\Resources\SmartCollectionResource;
...
trait ManagesCollections
{
    ...
    public function paginateCustomCollections(array $params): Paginator
    {
        return $this->paginator($this->getCustomCollections($params));
    }
