...
use TONYLABS\Shopify\REST\Resources\ImageResource;
use TONYLABS\Shopify\REST\Resources\ProductResource;
use TONYLABS\Shopify\REST\Resources\VariantResource;
...
trait ManagesProducts
{
    ...
    public function paginateProducts(array $params = []): Paginator
    {
        return $this->paginator($this->getProducts($params));
    }
    ...
    public function paginateVariants($productId, array $params = []): Paginator
    {
        return $this->paginator($this->getVariants($productId, $params));
    }
    ...
    public function paginateProductImages($productId, array $params = []): Paginator
    {
        return $this->paginator($this->getProductImages($productId, $params));
    }
