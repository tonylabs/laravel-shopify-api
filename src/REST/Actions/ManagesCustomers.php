...
use TONYLABS\Shopify\REST\Resources\CustomerResource;
...
trait ManagesCustomers
{
    ...
    public function paginateSearchCustomers(string $query, array $params = []): Paginator
    {
        return $this->paginator($this->searchCustomers($query, $params));
    }
    ...
    public function paginateCustomers(array $params = []): Paginator
    {
        return $this->paginator($this->getCustomers($params));
    }
    ...
    public function paginateCustomerOrders($customerId, array $params = []): Paginator
    {
        return $this->paginator($this->getCustomerOrders($customerId, $params));
    }
