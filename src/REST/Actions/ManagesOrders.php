...
use TONYLABS\Shopify\REST\Resources\DraftOrderResource;
use TONYLABS\Shopify\REST\Resources\OrderResource;
use TONYLABS\Shopify\REST\Resources\RefundResource;
use TONYLABS\Shopify\REST\Resources\RiskResource;
use TONYLABS\Shopify\REST\Resources\TransactionResource;
...
trait ManagesOrders
{
    ...
    public function paginateOrders(array $params = []): Paginator
    {
        return $this->paginator($this->getOrders($params));
    }
    ...
    public function paginateDraftOrders(array $params = []): Paginator
    {
        return $this->paginator($this->getDraftOrders($params));
    }
